...
export default function ProfilePage() {
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex flex-col items-center justify-center space-y-6 mt-20">
            ...
            <button
              ...
              className="px-8 py-3 bg-purple-500 hover:bg-purple-600 text-white font-bold rounded-lg transition-all duration-200 flex items-center gap-2 shadow-lg shadow-purple-500/20"
            >
  ...
  // Update the theme colors and styles to match the AuditPage screenshot
  const themeColors = {
    ...
    hoverBorderSecondary: 'hover:border-purple-500/30',
    textPrimary: 'text-purple-400',
    textWhite: 'text-white',
    bgPrimary: 'bg-purple-500',
    hoverBgPrimary: 'hover:bg-purple-600',
    shadowPrimary: 'shadow-purple-500/20',
  };

  return (
    <div className={`min-h-screen py-12 ${themeColors.secondary}`}>
      <div className="max-w-6xl mx-auto px-4">
        {/* Profile Header */}
        <div className={`${themeColors.bgSecondary} ${themeColors.borderSecondary} ${themeColors.hoverBorderSecondary} transition-colors duration-300 rounded-lg p-6 mb-8 ${themeColors.shadow}`}>
          <div className="flex items-start justify-between">
            <div>
              <div className={`inline-block mb-3 px-4 py-1 rounded-full ${themeColors.bg} ${themeColors.borderPrimary}`}>
                <span className={`${themeColors.textPrimary} text-sm font-semibold`}>Auditor Dashboard</span>
              </div>
              <h1 className="text-3xl font-mono font-bold mb-2">Auditor Profile</h1>
              <div className={`flex items-center space-x-2 ${themeColors.text} ${themeColors.secondary} rounded-lg px-3 py-1.5 ${themeColors.borderSecondary} inline-flex`}>
                <User size={16} className={themeColors.textPrimary} weight="bold" />
                <span className="font-mono">{address}</span>
                <a
                  href={`https://etherscan.io/address/${address}`}
                  target="_blank"
                  rel="noopener noreferrer"
                  className={`${themeColors.textPrimary} hover:text-purple-300 transition-colors`}
                >
            ...
            <button
              ...
              className={`p-2 ${themeColors.bg} rounded-lg transition-colors duration-200`}
              title="Refresh Stats"
            >
              <CircleNotch 
                size={24} 
                weight="bold"
                className={`${themeColors.textPrimary} ${isLoading ? 'animate-spin' : ''}`}
              />
            </button>
          </div>
        </div>
        ...
        {isLoading ? (
          <div className="flex items-center justify-center py-20">
            <div className="flex flex-col items-center">
              ...
              <span className={themeColors.textPrimary}>Loading your profile data...</span>
            </div>
          </div>
        ) : (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="space-y-8">
              {/* Overall Stats */}
              <div className={`${themeColors.bgSecondary} ${themeColors.borderSecondary} ${themeColors.hoverBorderSecondary} transition-colors duration-300 rounded-lg p-6 ${themeColors.shadow}`}>
                <div className="flex items-center gap-2 mb-4">
                  <ChartBar size={20} className={themeColors.textPrimary} weight="duotone" />
                  <h2 className="text-xl font-mono">Overall Statistics</h2>
                </div>
                <div className="grid grid-cols-2 gap-4">
                  <div className={`${themeColors.secondary} rounded-lg p-4 ${themeColors.borderSecondary} ${themeColors.hoverBorderSecondary} transition-colors duration-300`}>
                    <div className="text-3xl font-bold text-white">{stats.totalAudits}</div>
                    <div className={`text-sm ${themeColors.textPrimary} mt-1`}>Total Audits</div>
                  </div>
                  <div className={`${themeColors.secondary} rounded-lg p-4 ${themeColors.borderSecondary} ${themeColors.hoverBorderSecondary} transition-colors duration-300`}>
                    <div className="flex items-center space-x-1">
                      ...
                      <Star weight="fill" className={themeColors.textPrimary} size={20} />
                    </div>
                    <div className={`text-sm ${themeColors.textPrimary} mt-1`}>Average Rating</div>
                  </div>
                </div>
              </div>
              ...
              <div className={`${themeColors.bgSecondary} ${themeColors.borderSecondary} ${themeColors.hoverBorderSecondary} transition-colors duration-300 rounded-lg p-6 ${themeColors.shadow}`}>
                <div className="flex items-center gap-2 mb-4">
                  <Lightning size={20} className={themeColors.textPrimary} weight="duotone" />
                  ...
                  {Object.entries(stats.chainBreakdown).map(([chain, count]) => (
                    <div key={chain} className="flex items-center space-x-4">
                      <div className="relative">
                        <div className={`absolute inset-0 ${themeColors.bg} rounded-full blur-[2px]`}></div>
                        <Image
                      ...
                      <div className="flex-1">
                        <div className="flex justify-between items-center mb-1">
                          ...
                          <span className={`text-gray-400 px-2 py-0.5 rounded-full ${themeColors.bg} ${themeColors.textPrimary} text-xs ${themeColors.borderPrimary}`}>{count} audits</span>
                        </div>
                        <div className={`h-2 ${themeColors.secondary} rounded-full overflow-hidden`}>
                          <div
                            className={`h-full ${themeColors.bgPrimary}`}
                            style={{
            ...
            <div className={`${themeColors.bgSecondary} ${themeColors.borderSecondary} ${themeColors.hoverBorderSecondary} transition-colors duration-300 rounded-lg p-6 ${themeColors.shadow}`}>
              <div className="flex items-center gap-2 mb-4">
                <ListChecks size={20} className={themeColors.textPrimary} weight="duotone" />
              ...
              <div className="space-y-4">
                {stats.recentAudits.map((audit) => (
                  <div
                    ...
                    className={`${themeColors.secondary} rounded-lg p-4 ${themeColors.borderSecondary} ${themeColors.hoverBorderSecondary} transition-colors duration-300`}
                  >
                    <div className="flex justify-between items-start mb-3">
                      <div className={`font-mono text-sm px-2 py-0.5 rounded ${themeColors.bg} ${themeColors.textPrimary} ${themeColors.borderPrimary}`}>
                      ...
                      <div className="flex items-center space-x-1">
                        {[...Array(5)].map((_, i) => (
                          <Star
                            ...
                            className={i < audit.stars ? themeColors.textPrimary : "text-gray-600"}
                            size={16}
                          />
                        ))}
                      </div>
                    ...
                    <div className="flex justify-between items-center text-sm">
                      <div className="flex items-center space-x-2">
                        <div className="relative">
                          <div className={`absolute inset-0 ${themeColors.bg} rounded-full blur-[1px]`}></div>
                          <Image
                      ...
                      <span className={`text-xs px-2 py-0.5 rounded-full ${themeColors.secondary} text-gray-400 ${themeColors.borderSecondary}`}>
                ...
                {stats.recentAudits.length === 0 && (
                  <div className={`text-center py-12 ${themeColors.secondary} rounded-lg ${themeColors.borderSecondary}`}>
                    <div className="flex flex-col items-center">
                      <ListChecks size={48} className="text-purple-400/50 mb-4" weight="duotone" />
                      <p className="text-gray-400 mb-2">No audits found</p>
                      <span className={`text-xs px-3 py-1 rounded-full ${themeColors.bg} ${themeColors.textPrimary} ${themeColors.borderPrimary}`}>
